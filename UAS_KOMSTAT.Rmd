...
Data reviews yang digunakan untuk analisis ini Animal Crossing: New Horizons adalah video game simulasi kehidupan tahun 2020 yang dikembangkan dan diterbitkan oleh Nintendo untuk Nintendo Switch. New Horizons melihat pemain mengambil peran karakter yang dapat disesuaikan yang pindah ke pulau terpencil setelah membeli paket dari Tom Nook, karakter tanuki yang muncul di setiap entri dalam seri Animal Crossing. Berlangsung secara real-time, pemain dapat menjelajahi pulau secara nonlinier, mengumpulkan dan membuat barang, menangkap serangga dan ikan, dan mengembangkan pulau menjadi komunitas hewan antropomorfik.data tersebut diubah ke csv kemudin di import ke R. SUumber data : https://www.kaggle.com/datasets/jessemostipak/animal-crossing
...
Korpus hanyalah kumpulan dokumen. Dokumen dapat berupa teks dari pidato, buku, artikel berita, ulasan produk, dll. Korpus dibuat dari teks pidato di bawah ini.
